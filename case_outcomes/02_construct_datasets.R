...
write_csv(fundada_appeal_data_did,
  paste0(data_amag_fin, "00_analysis/dataset_caseid_month_fundada_did.csv"))

write_csv(resolution_data_did,
  paste0(data_amag_fin, "00_analysis/dataset_caseid_month_resolution_did.csv"))

write_csv(days_to_res_data_did,
  paste0(data_amag_fin, "00_analysis/dataset_caseid_month_days_to_res_did.csv"))