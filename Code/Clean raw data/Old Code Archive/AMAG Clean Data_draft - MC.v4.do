...
save "randomization_treatment.dta", replace
...
tab participant_index_in_pages if iat1playerskip_iat==0 & feedback_or_not==0 & _merge==3 & iat_take_or_not==1, missing //page index
...
export excel using "/Users/mayumicornejo/Desktop/World Bank /Estado de cuaestionario.xlsx", sheetreplace firstrow(variables)
