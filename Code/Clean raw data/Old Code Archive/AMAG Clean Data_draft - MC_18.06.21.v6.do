...
graph export "TrolleybyTreatment.png", replace 
...
graph export "TrolleybyTreatmentGender.png", replace 
...
graph export "TrolleybyTreatmentJudge.png", replace 
...
graph export "TrolleybyTreatmentProsecutor.png", replace 
...
graph export "TrolleybyMaleTreatment.png", replace 
...
graph export "TrolleybyMaleTreatmentJudge.png", replace 
...
graph export "TrolleybyMaleTreatmentProsecutor.png", replace 
...
graph export "TrolleybyFootbridgeTreatment.png", replace 
...
graph export "TrolleybyFootbridgeTreatmentJudge.png", replace 
...
graph export "TrolleybyFootbridgeTreatmentProsecutor.png", replace 
...
graph export "ChoseSkipIATbyGender.png", replace 
...
graph export "ChoseSkipIATbyRole.png", replace 
...
graph export "ChoseSkipIATbyGenderRole.png", replace 
...
graph export "IATDesirelevelbyRole.png", replace 
...
graph export "IATDesirelevelbyGender.png", replace   
...
graph export "IATWantfeedbackbyRole.png", replace 
...
graph export "IATWantfeedbackbyGender.png", replace 
...
graph hbar redistribute_player_decision, over(Cargo) ytitle("Player decision") title("Mean Redistribution Decisions by Role") //Need to know what the redistribute variable corresponds to
graph export "RedistributedecisionbyRole.png", replace 

graph hbar redistribute_player_decision, over(Género) ytitle("Player decision") title("Mean Redistribution Decisions by Gender")
graph export "RedistributedecisionbyGender.png", replace 
...
//RJ: 
graph hbar games_solo1playerdictator_decisi, over(Cargo) ytitle("Player decision") title("Mean Altruism Decisions by Role")
graph export "AltruismdecisionbyRole.png", replace 

graph hbar games_solo1playerdictator_decisi, over(Género) ytitle("Player decision") title("Mean Altruism Decisions by Gender")
graph export "AltruismdecisionbyGender.png", replace 
